...
<div class="d-flex col-6 py-5 m-auto align-items-center justify-content-center flex-column">
    ...
    <div class="caja_icono p-4 position-relative">
        ...
        <div class="caja_fondo3 caja_fondo"> </div>

        <img class="position-relative" src="images/folleto.png" alt="">

    </div>


    <h4 class="mt-3 titulo font-weight-bold"> Señalicazión Industrial </h4>
